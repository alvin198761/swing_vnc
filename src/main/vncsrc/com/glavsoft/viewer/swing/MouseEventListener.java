...
public class MouseEventListener extends MouseInputAdapter
    ...
    private volatile double scaleFactorx, scaleFactory;
    ...
    public void setScaleFactor(double x, double y) {
        this.scaleFactorx = x;
        this.scaleFactory = y;
    }
    ...
    public void processMouseEvent(MouseEvent mouseEvent,
        ...
        short x = (short) (mouseEvent.getX() / scaleFactorx);
        short y = (short) (mouseEvent.getY() / scaleFactory);
        if (moved) {
    ...
    public void mousePressed(MouseEvent mouseEvent) {
        ((Component) mouseEvent.getSource()).requestFocusInWindow();
